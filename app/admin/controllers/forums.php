...
(function() {
    ...
    // 版块名称关键字 → 推荐图标映射（顺序优先）
    var suggestRules = [
        { keys: [<?php echo addslashes(t('admin_forums_3f9569','公告')); ?>, <?php echo addslashes(t('admin_forums_7a66c0','通知')); ?>, <?php echo addslashes(t('admin_forums_753ccc','动态')); ?>, <?php echo addslashes(t('admin_forums_210ce7','官方')); ?>, 'news', 'notice'], icon: 'announcement' },
        { keys: [<?php echo addslashes(t('admin_forums_663800','后端')); ?>, <?php echo addslashes(t('admin_forums_30d94c','服务器')); ?>, 'python', 'java', 'go', 'rust', 'node', 'php', 'backend'], icon: 'code' },
        { keys: [<?php echo addslashes(t('admin_forums_7a19a8','前端')); ?>, <?php echo addslashes(t('admin_forums_06caf5','网页')); ?>, 'css', 'html', 'javascript', 'js', 'vue', 'react', 'frontend', 'ui'], icon: 'design' },
        { keys: [<?php echo addslashes(t('admin_forums_f4dbbc','数据库')); ?>, 'mysql', 'sqlite', 'redis', 'mongo', 'sql', 'db'], icon: 'database' },
        { keys: [<?php echo addslashes(t('admin_forums_33246d','代码')); ?>, <?php echo addslashes(t('admin_forums_3b70f4','编程')); ?>, <?php echo addslashes(t('admin_forums_eb3774','开发')); ?>, <?php echo addslashes(t('admin_forums_1a68c2','程序')); ?>, 'coding', 'dev'], icon: 'code' },
        { keys: [<?php echo addslashes(t('admin_forums_b4cd99','硬件')); ?>, 'cpu', <?php echo addslashes(t('admin_forums_3d639f','显卡')); ?>, <?php echo addslashes(t('admin_forums_7fef5a','主板')); ?>, <?php echo addslashes(t('admin_forums_d014ab','内存')); ?>, <?php echo addslashes(t('admin_forums_90312d','硬盘')); ?>, <?php echo addslashes(t('admin_forums_76ecf2','组装')); ?>], icon: 'cpu' },
        { keys: [<?php echo addslashes(t('admin_forums_0cbda6','网络')); ?>, <?php echo addslashes(t('admin_forums_4ed766','互联网')); ?>, 'http', 'tcp', <?php echo addslashes(t('admin_forums_19da0c','路由')); ?>, 'wifi', 'network'], icon: 'globe' },
        { keys: [<?php echo addslashes(t('admin_forums_2ea617','云')); ?>, 'cloud', 'aws', <?php echo addslashes(t('admin_forums_20ef37','阿里云')); ?>, <?php echo addslashes(t('admin_forums_88f4c7','腾讯云')); ?>, <?php echo addslashes(t('admin_forums_3220a1','部署')); ?>, <?php echo addslashes(t('admin_forums_57bd58','运维')); ?>], icon: 'cloud' },
        { keys: [<?php echo addslashes(t('admin_forums_8e662a','安全')); ?>, <?php echo addslashes(t('admin_forums_c51f0d','加密')); ?>, <?php echo addslashes(t('admin_forums_adfb29','渗透')); ?>, <?php echo addslashes(t('admin_forums_86835d','漏洞')); ?>, <?php echo addslashes(t('admin_forums_885e1d','防护')); ?>, 'security'], icon: 'shield' },
        { keys: [<?php echo addslashes(t('admin_forums_2305ee','游戏')); ?>, <?php echo addslashes(t('admin_forums_ba958f','电竞')); ?>, <?php echo addslashes(t('admin_forums_0f300e','网游')); ?>, <?php echo addslashes(t('admin_forums_2e8a0c','主机')); ?>, 'steam', 'game'], icon: 'game' },
        { keys: [<?php echo addslashes(t('admin_forums_4c83e1','影视')); ?>, <?php echo addslashes(t('admin_forums_ba723f','电影')); ?>, <?php echo addslashes(t('admin_forums_325813','电视')); ?>, <?php echo addslashes(t('admin_forums_24caf3','剧')); ?>, <?php echo addslashes(t('admin_forums_8ca4a7','动漫')); ?>, 'film', 'movie', 'anime'], icon: 'film' },
        { keys: [<?php echo addslashes(t('admin_forums_afb3c4','音乐')); ?>, <?php echo addslashes(t('admin_forums_bf52cf','歌曲')); ?>, <?php echo addslashes(t('admin_forums_3a3857','歌')); ?>, <?php echo addslashes(t('admin_forums_8eaf85','乐')); ?>, 'music', 'song'], icon: 'music' },
        { keys: [<?php echo addslashes(t('admin_forums_dc2d97','摄影')); ?>, <?php echo addslashes(t('admin_forums_6042a0','相机')); ?>, <?php echo addslashes(t('admin_forums_3da4b3','拍照')); ?>, <?php echo addslashes(t('admin_forums_48e9e5','照片')); ?>, 'photo', 'camera'], icon: 'camera' },
        { keys: [<?php echo addslashes(t('admin_forums_82d0f5','体育')); ?>, <?php echo addslashes(t('admin_forums_9d99da','运动')); ?>, <?php echo addslashes(t('admin_forums_514ef7','足球')); ?>, <?php echo addslashes(t('admin_forums_bfb578','篮球')); ?>, 'sport', 'football'], icon: 'sport' },
        { keys: [<?php echo addslashes(t('admin_forums_2e33ad','写作')); ?>, <?php echo addslashes(t('admin_forums_6eb705','小说')); ?>, <?php echo addslashes(t('admin_forums_de5ec3','文学')); ?>, <?php echo addslashes(t('admin_forums_d53864','散文')); ?>, <?php echo addslashes(t('admin_forums_ad3fd0','文章')); ?>, 'writing'], icon: 'pen' },
        { keys: [<?php echo addslashes(t('admin_forums_e1bd09','读书')); ?>, <?php echo addslashes(t('admin_forums_2b1e69','书籍')); ?>, <?php echo addslashes(t('admin_forums_fe0427','书')); ?>, 'book', <?php echo addslashes(t('admin_forums_aac0ef','阅读')); ?>], icon: 'book' },
        { keys: [<?php echo addslashes(t('admin_forums_c5ca39','资源')); ?>, <?php echo addslashes(t('admin_forums_7a9243','分享')); ?>, <?php echo addslashes(t('admin_forums_2b9d01','下载')); ?>, <?php echo addslashes(t('admin_forums_75e00c','素材')); ?>, 'resource', 'share', 'gift'], icon: 'gift' },
        { keys: [<?php echo addslashes(t('admin_forums_0ea257','闲聊')); ?>, <?php echo addslashes(t('admin_forums_ba64d5','灌水')); ?>, <?php echo addslashes(t('admin_forums_5358b2','聊天')); ?>, <?php echo addslashes(t('admin_forums_5629ca','水区')); ?>, <?php echo addslashes(t('admin_forums_05b368','聊天室')); ?>, 'chat'], icon: 'chat' },
        { keys: [<?php echo addslashes(t('admin_forums_db4224','咖啡')); ?>, <?php echo addslashes(t('admin_forums_97a08c','茶')); ?>, <?php echo addslashes(t('admin_forums_b78bd2','饮品')); ?>, <?php echo addslashes(t('admin_forums_8e1145','生活')); ?>, <?php echo addslashes(t('admin_forums_8d0e83','日常')); ?>, 'coffee', 'life'], icon: 'coffee' },
        { keys: [<?php echo addslashes(t('admin_forums_8e1145','生活')); ?>, <?php echo addslashes(t('admin_forums_226825','情感')); ?>, <?php echo addslashes(t('admin_forums_300ee5','心情')); ?>, 'heart'], icon: 'heart' },
        { keys: [<?php echo addslashes(t('admin_forums_42a36e','反馈')); ?>, <?php echo addslashes(t('admin_forums_c5134e','建议')); ?>, <?php echo addslashes(t('admin_forums_5562d2','意见')); ?>, 'bug', <?php echo addslashes(t('admin_forums_2fb49e','问题')); ?>, <?php echo addslashes(t('admin_forums_adf465','帮助')); ?>, 'help', 'feedback'], icon: 'help' },
        { keys: [<?php echo addslashes(t('admin_forums_e77290','想法')); ?>, <?php echo addslashes(t('admin_forums_f36817','创意')); ?>, <?php echo addslashes(t('admin_forums_6428c3','点子')); ?>, <?php echo addslashes(t('admin_forums_ae2e58','灵感')); ?>, 'idea', 'lightbulb'], icon: 'lightbulb' },
        { keys: [<?php echo addslashes(t('admin_forums_61bf13','热门')); ?>, <?php echo addslashes(t('admin_forums_d24048','精选')); ?>, <?php echo addslashes(t('admin_forums_7de02c','精华')); ?>, <?php echo addslashes(t('admin_forums_2c39ed','人气')); ?>, 'hot', 'fire'], icon: 'fire' },
        { keys: [<?php echo addslashes(t('admin_forums_7de02c','精华')); ?>, <?php echo addslashes(t('admin_forums_62b46f','推荐')); ?>, 'star'], icon: 'star' },
        { keys: [<?php echo addslashes(t('admin_forums_a72ef1','工具')); ?>, <?php echo addslashes(t('admin_forums_1e34fd','软件')); ?>, <?php echo addslashes(t('admin_forums_62b46f','推荐')); ?>, 'tool'], icon: 'tool' },
        { keys: [<?php echo addslashes(t('admin_forums_ec87a4','电脑')); ?>, <?php echo addslashes(t('admin_forums_3294fc','笔记本')); ?>, <?php echo addslashes(t('admin_forums_6e9ece','台式')); ?>, 'pc', 'desktop'], icon: 'desktop' },
        { keys: [<?php echo addslashes(t('admin_forums_9ba763','用户')); ?>, <?php echo addslashes(t('admin_forums_ed6b21','会员')); ?>, <?php echo addslashes(t('admin_forums_6a5e50','新人')); ?>, <?php echo addslashes(t('admin_forums_b96ae2','报道')); ?>, 'user'], icon: 'users' },
        { keys: [<?php echo addslashes(t('admin_forums_1c8e46','邮件')); ?>, <?php echo addslashes(t('admin_forums_9ed627','邮箱')); ?>, 'mail', 'email'], icon: 'mail' },
        { keys: [<?php echo addslashes(t('admin_forums_9171c7','火箭')); ?>, <?php echo addslashes(t('admin_forums_03d53e','创业')); ?>, <?php echo addslashes(t('admin_forums_22336e','项目')); ?>, 'startup', 'rocket'], icon: 'rocket' },
        { keys: [<?php echo addslashes(t('admin_forums_46e1ef','地图')); ?>, <?php echo addslashes(t('admin_forums_88c344','位置')); ?>, <?php echo addslashes(t('admin_forums_e8666c','本地')); ?>, <?php echo addslashes(t('admin_forums_17fc93','区域')); ?>, 'map'], icon: 'map' },
        { keys: [<?php echo addslashes(t('admin_forums_7a66c0','通知')); ?>, <?php echo addslashes(t('admin_forums_81944e','提醒')); ?>, 'bell'], icon: 'bell' },
        { keys: [<?php echo addslashes(t('admin_forums_7debf9','设置')); ?>, <?php echo addslashes(t('admin_forums_d7d7ce','配置')); ?>, <?php echo addslashes(t('admin_forums_1a1f6d','系统')); ?>, 'cog', 'setting'], icon: 'cog' },
        { keys: [<?php echo addslashes(t('admin_forums_1ed10b','庆祝')); ?>, <?php echo addslashes(t('admin_forums_b25486','活动')); ?>, <?php echo addslashes(t('admin_forums_83cd4e','节日')); ?>, 'party', 'event'], icon: 'party' },
        { keys: [<?php echo addslashes(t('admin_forums_820f5b','书签')); ?>, <?php echo addslashes(t('admin_forums_d07cee','收藏')); ?>, 'bookmark'], icon: 'bookmark' },
        { keys: [<?php echo addslashes(t('admin_forums_475833','标志')); ?>, <?php echo addslashes(t('admin_forums_ae0a7a','标签')); ?>, 'flag'], icon: 'flag' },
        { keys: [<?php echo addslashes(t('admin_forums_9171c7','火箭')); ?>, <?php echo addslashes(t('admin_forums_2dd56c','航天')); ?>, <?php echo addslashes(t('admin_forums_492b7e','太空')); ?>, 'space'], icon: 'rocket' }
    ];
