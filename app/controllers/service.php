...
<div class="card" style="max-width: 900px; margin: 0 auto;">
    <div class="page-header" style="border-bottom: 1px solid var(--border); padding-bottom: 1rem;">
        <h1 class="page-title"><?php echo e($pageData['title'] ?? t('service_page_title', '服务协议')); ?></h1>
        <p class="text-muted"><?php echo e(t('service_last_updated', '最后更新日期：{date}', ['date' => $pageData['updated_at'] ?? date('Y-m-d')])); ?></p>
    </div>
