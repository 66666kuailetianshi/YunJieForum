<?php return [
    ...
    'admin_ajax_ss_linux_proc_warning'           => 'System info is limited: open_basedir restricts PHP from reading /proc and /sys (current value: {ob}). Load average and system identity are now collected via syscall APIs (sys_getloadavg/php_uname/getrusage); CPU cores/memory/CPU usage are estimated values (marked on the page); temperature/GPU/motherboard hardware info is still unavailable. For precise data, append :/proc:/sys to open_basedir in your hosting panel (e.g. BaoTa) and refresh.',
