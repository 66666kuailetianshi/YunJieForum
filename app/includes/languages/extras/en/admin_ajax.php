<?php return [
    ...
    'admin_ajax_ss_linux_proc_warning'           => 'System info is limited: open_basedir restricts PHP from reading /proc and /sys (current value: {ob}), so CPU cores/memory/temperature data are unavailable. In your hosting panel (e.g. BaoTa), append :/proc:/sys to open_basedir and refresh, or disable open_basedir entirely.',
